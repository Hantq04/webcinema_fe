...
const translations = {
  vi: {
    ...
    management: {
      ...
      seatModalGenerateDesc: 'Tạo toàn bộ ghế tự động cho một phòng chiếu.',
      seatModalRoomName: 'Tên phòng',
      seatModalRoomCode: 'Mã phòng',
      seatModalEditTitle: 'Cập nhật ghế',
      seatModalEditDesc: 'Sửa thông tin dòng và số của ghế.',
      seatModalDeleteTitle: 'Xác nhận xóa',
      seatModalDeleteDesc: 'Bạn có chắc muốn xóa ghế này?',
      seatModalRefreshTitle: 'Làm mới ghế theo hóa đơn',
      seatModalRefreshDesc: 'Nhập mã giao dịch (Trading Code) của hóa đơn để giải phóng hoặc làm mới ghế.',
  ...
  en: {
    ...
    management: {
      ...
      seatModalGenerateTitle: 'Generate Seats',
      seatModalGenerateDesc: 'Automatically generate all seats for a specific room.',
      ...
      seatModalDeleteTitle: 'Confirm Delete',
      seatModalDeleteDesc: 'Are you sure you want to delete this seat?',
      seatModalRefreshTitle: 'Refresh Seats by Bill',
      seatModalRefreshDesc: 'Enter the bill trading code to release or refresh seat status.',
