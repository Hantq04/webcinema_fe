    ...
    <div class="management-container" [class.collapsed]="isCollapsed()">
      ...
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
          <a routerLink="/management/dashboard" routerLinkActive="active" class="nav-item">
          ...
          <a routerLink="/management/seats" routerLinkActive="active" class="nav-item">
          ...
          <a href="javascript:void(0)" (click)="showAlert($event)" class="nav-item">
            <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 20V10"/><path d="M12 9A6 6 0 0 0 6 9h12A6 6 0 0 0 12 9z"/><path d="M6 20V10"/><path d="M12 20V10"/><path d="M6 20h12"/></svg>
            <span class="nav-label" *ngIf="!isCollapsed()">{{ t('management.foodBeverages') }}</span>
          </a>
          <a href="javascript:void(0)" (click)="showAlert($event)" class="nav-item">
            ...
            <span class="nav-label" *ngIf="!isCollapsed()">{{ t('management.promotions') }}</span>
          </a>
          ...
          <a href="javascript:void(0)" (click)="showAlert($event)" class="nav-item">
            ...
            <span class="nav-label" *ngIf="!isCollapsed()">{{ t('management.customers') }}</span>
          </a>
          <a href="javascript:void(0)" (click)="showAlert($event)" class="nav-item">
            <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="14" x="3" y="6" rx="2"/><path d="M21 14H3"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><path d="M12 14v7"/></svg>
            <span class="nav-label" *ngIf="!isCollapsed()">{{ t('management.staff') }}</span>
          </a>
          <a href="javascript:void(0)" (click)="showAlert($event)" class="nav-item">
